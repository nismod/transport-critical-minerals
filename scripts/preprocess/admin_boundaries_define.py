...
def main(config):
    ...
    if status is True:
        ...
        baci_trade_africa.rename(columns = {"country_name_abbreviation":"from_country",   
                                            "iso_3digit_alpha":"from_iso"},inplace=True)
        ...
        baci_trade_africa.rename(columns = {"country_name_abbreviation":"to_country",   
                                            "iso_3digit_alpha":"to_iso"},inplace=True)
        ...
        baci_trade_africa = pd.merge(baci_trade_africa,
                                commodites,
                                how="left",left_on=["k"],right_on=["code"])
        baci_trade_africa.drop(["code"],
                        axis=1,inplace=True)
        baci_trade_africa.to_csv(os.path.join(processed_data_path,
                            "baci","ccg_country_critical_mineral_commodity_trade.csv"),
                        index=False)
